<?php $__env->startSection('content'); ?>
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="title" value="<?php echo e($_SESSION['data']['title'] ?? $tag -> title); ?>">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="slug" name="slug" value="<?php echo e($_SESSION['data']['title'] ?? $tag -> title); ?>">
        </div>
        <div class="mb-3">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/hw10_1.test/resources/views/tag/tag-form.blade.php ENDPATH**/ ?>